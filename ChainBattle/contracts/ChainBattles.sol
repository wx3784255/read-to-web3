...
function getCharacter(uint256 tokenId) public returns(string memory){
    ...
    bytes memory svg = abi.encodePacked(
       '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 300 180" preserveAspectRatio="xMidYMid meet">',
        '<style>.character { fill: white; font-family: verdana; font-size: 15px; }</style>',
        ...
        '<text x="70%" y="40%" class="character" dominant-baseline="middle" text-anchor="middle">',"Warrior Class",'</text>',
        '<text x="70%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Level: ",getLevel(tokenId),'</text>',
        '<text x="70%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">', "Health: ",getHealth(tokenId),'</text>',
        '<text x="70%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strength: ",getStrength(tokenId),'</text>',
        '<text x="70%" y="80%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",getSpeed(tokenId),'</text>',
    '</svg>'
